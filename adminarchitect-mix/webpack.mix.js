...
mix
     ...
     *
     * @requires `tinymce@^5.9.1` package
     * @note npm i tinymce@5 --save-dev
     */
     ...
     * Assembles CK editor
     *
     * @requires `ckeditor4` package
     * @note npm i ckeditor4 --save-dev
     */
    // .copy([
    ...
    // ], 'build/editors')
    // .copy('node_modules/ckeditor/lang/fr.js', 'build/editors/lang/en.js')
    ...
    //.js('resources/js/yasala-drop-zone.js','build')
    .extract([
        'vue',
        'vue-clip',
        'axios',
